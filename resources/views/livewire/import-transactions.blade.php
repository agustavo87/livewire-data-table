<div>
    <x-button.secondary wire:click="$toggle('showModal')" class="flex items-center space-x-2"><x-icons.upload class="text-gray-500"/> <span>Import</span></x-button.secondary>
            ...
            <x-slot name="content">
                ...
                <div class="py-12 flex flex-col items-center justify-center ">
                    <div class="flex items-center space-x-2 text-xl">
                        <x-icons.upload class="text-gray-400 h-8 w-8" />
                        <x-input.file-upload wire:model="upload" id="upload" caption="Select file"><span class="text-gray-500 font-bold">CSV File</span></x-input.file-upload>
                    </div>
